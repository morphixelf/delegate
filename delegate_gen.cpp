...
public:
    ...
    void AddDelegate(bool RetVal, int ArgsCount, bool Primary = false)
    {
        ...
        std::string stub_type_args         = Join("const ptr_type &",type_list);
        std::string func_stub_args         = Join("const ptr_type &ptr",type_val_list);
        std::string method_stub_templ_args = Join((RetVal ? "class _ret_type" : ""),_typename_list,"class obj_type",_ret_type+" (obj_type::*method_type)("+_type_list+")");
        std::string method_stub_args       = Join("const ptr_type &ptr",_type_val_list);
        std::string stub_params            = Join("ptr",val_list);
        std::string stub_templ_params      = Join((RetVal ? "ret_type" : ""),type_list,"obj_type","method_type");
        ...
        AddLine("    typedef "+ret_type+" (*stub_type)("+stub_type_args+");");
        AddLine("");
        AddLine("    ptr_type ptr;");
        AddLine("    stub_type stub;");
        AddLine("");
        AddLine("    static "+ret_type+" func_stub("+func_stub_args+")");
        AddLine("    {");
        AddLine("        "+return_cmd+"ptr.func("+val_list+");");
        AddLine("    }");
        AddLine("");
        AddLine("    template <"+method_stub_templ_args+">");
        AddLine("    static "+_ret_type+" method_stub("+method_stub_args+")");
        AddLine("    {");
        AddLine("        "+return_cmd+"(static_cast<obj_type *>(ptr.obj)->*method_type)("+val_list+");");
        AddLine("    }");
        AddLine("");
        AddLine("    template <"+method_stub_templ_args+" const>");
        AddLine("    static "+_ret_type+" const_method_stub("+method_stub_args+")");
        AddLine("    {");
        AddLine("        "+return_cmd+"(static_cast<obj_type *>(ptr.obj)->*method_type)("+val_list+");");
        AddLine("    }");
        AddLine("");
        AddLine("    "+class_name+"(void *p, stub_type s)");
        AddLine("        : ptr(p)");
        AddLine("        , stub(s)");
        AddLine("    {}");
        AddLine("public:");
        ...
        AddLine("        , stub(&func_stub)");
        AddLine("    {}");
        AddLine("");
        AddLine("    operator bool() const");
        AddLine("    {");
        AddLine("        return stub != 0;");
        AddLine("    }");
        AddLine("");
        AddLine("    "+ret_type+" operator()("+type_val_list+") const");
        AddLine("    {");
        AddLine("        "+return_cmd+"(*stub)("+stub_params+");");
        AddLine("    }");
        AddLine("");
        ...
        AddLine("    {");
        AddLine("        return delegate_type(obj_ptr, &method_stub<"+stub_templ_params+">);");
        AddLine("    }");
        AddLine("");
        ...
        AddLine("    {");
        AddLine("        return delegate_type(const_cast<obj_type *>(obj_ptr), &const_method_stub<"+stub_templ_params+">);");
        AddLine("    }");
        AddLine("};");
    }
